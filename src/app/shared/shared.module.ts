...
import { FilterPipe, OnlyMainPipe, FilterOnValuePipe, OnlyCheckedPipe, OnlyIncompletedPipe, OnlyCompletedPipe} from '../pipes/filter.pipe';
...
@NgModule({
  ...
  declarations: [
    OnlyCompletedPipe, OnlyMainPipe, FilterPipe, FilterOnValuePipe, OnlyCheckedPipe, OnlyIncompletedPipe,
